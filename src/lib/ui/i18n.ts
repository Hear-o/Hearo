  ...
  en: {
    translation: {
      ...
      session: {
        ...
        goBack: "Go back",
        noWatch: "No heart-rate source detected. Use the button on screen to lower trigger volume when needed.",
        watchDisconnected: "Heart-rate source disconnected. Use the button to control trigger volume manually.",
  ...
  he: {
    translation: {
      ...
      session: {
        ...
        preparing: "מכין סשן…",
        goBack: "חזרה",
        noWatch: "לא זוהה מקור דופק. השתמש בכפתור על המסך להנמכת הצליל.",
        watchDisconnected: "מקור הדופק התנתק. השתמש בכפתור לשליטה ידנית בעוצמה.",
