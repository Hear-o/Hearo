  ...
  en: {
    translation: {
      ...
      chat: {
        ...
        homeHint: "Talk with an on-device assistant",
        new: "New",
        newConversation: "New conversation",
        disclaimer: "Private, on-device support — not a replacement for emergency care.",
        empty: "What feels most present for you right now?",
  ...
  he: {
    translation: {
      ...
      setup: {
        ...
        sceneQuestion: "איפה בא לך\nלהיות?",
        soundsQuestion: "איזה צליל טריגר\nלתרגל?",
        soundsHint: "אפשר לבחור את מה שמרגיש נכון, ולשנות בכל עת.",
      ...
      chat: {
        title: "שיחה שקטה",
        homeHint: "שיחה עם עוזר שפועל במכשיר",
        new: "חדש",
        newConversation: "שיחה חדשה",
        disclaimer: "תמיכה פרטית שפועלת במכשיר — לא תחליף לעזרה דחופה.",
        empty: "מה הכי נוכח אצלך עכשיו?",
        messageLabel: "הודעה",
        placeholder: "אפשר לכתוב מה עובר עליך…",
        send: "שליחה",
        thinking: "חושב…",
        error: "לא הצלחתי לענות עכשיו. אפשר לנסות שוב.",
      },
