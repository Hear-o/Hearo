  ...
  he: {
    translation: {
      ...
      companion: {
        ...
        beta: "בטא",
        header: "צעד קטן אחד בכל פעם.\nבוא נראה מה נצליח להשיג היום.",
        pickScenario: "בחר תרחיש",
        ...
        addMedia: "הוסף תמונה או סרטון",
        locked: "סיים את הצעד הקודם כדי לפתוח את זה",
        replaceMedia: "החלף",
        removeMedia: "הסר",
        videoLabel: "סרטון",
        mediaSourceTitle: "הוסף תמונה או סרטון",
        sourceCamera: "צלם תמונה או סרטון",
        sourceLibrary: "בחר מהגלריה",
        cancel: "ביטול",
