...
const resources = {
  en: {
    translation: {
      ...
      triggerSound: {
        settingsLink: "Practice sound",
        settingsLinkHint: "Volume range and pace",
        title: "Practice sound",
        description:
          "Choose how softly the sound begins, how loud it may become, and how often it returns.",
        previewTitle: "Test your loudest setting",
        previewHint: "Plays one sound at {{percent}}%",
        preview: "Test sound",
        previewing: "Playing…",
        increase: "Increase",
        decrease: "Decrease",
        minimumVolume: "Starting volume",
        maximumVolume: "Maximum volume",
        volumeHint:
          "The sound gradually moves from the starting level toward your maximum during a session.",
        percent: "{{value}}%",
        pace: "Pace",
        paceSlow: "Slow",
        paceSteady: "Steady",
        paceFrequent: "Frequent",
        interval: "About every {{seconds}} seconds during practice.",
        reset: "Reset to defaults",
        save: "Save changes",
        saving: "Saving…",
        back: "Back to settings",
        loadError: "Couldn't load your sound settings. The defaults are shown.",
        saveError: "Couldn't save the changes. Please try again.",
        previewError: "Couldn't play the test sound. Please try again.",
      },
      session: {
        end: "End session",
        pause: "Pause",
  ...
  he: {
    translation: {
      ...
      triggerSound: {
        settingsLink: "צליל התרגול",
        settingsLinkHint: "טווח עוצמה וקצב",
        title: "צליל התרגול",
        description:
          "אפשר לבחור באיזו עוצמה הצליל מתחיל, עד כמה הוא יכול להתחזק, ובאיזו תדירות הוא חוזר.",
        previewTitle: "בדיקת העוצמה המרבית",
        previewHint: "השמעת צליל אחד בעוצמה של {{percent}}%",
        preview: "בדיקת צליל",
        previewing: "מתנגן…",
        increase: "הגברה",
        decrease: "הנמכה",
        minimumVolume: "עוצמת התחלה",
        maximumVolume: "עוצמה מרבית",
        volumeHint:
          "במהלך התרגול הצליל מתקדם בהדרגה מעוצמת ההתחלה אל העוצמה המרבית.",
        percent: "{{value}}%",
        pace: "קצב",
        paceSlow: "איטי",
        paceSteady: "קבוע",
        paceFrequent: "תכוף",
        interval: "בערך פעם ב-{{seconds}} שניות במהלך התרגול.",
        reset: "איפוס לברירת המחדל",
        save: "שמירת שינויים",
        saving: "שומרים…",
        back: "חזרה להגדרות",
        loadError: "לא הצלחנו לטעון את הגדרות הצליל. מוצגות ברירות המחדל.",
        saveError: "לא הצלחנו לשמור את השינויים. כדאי לנסות שוב.",
        previewError: "לא הצלחנו להשמיע את צליל הבדיקה. כדאי לנסות שוב.",
      },
      session: {
        end: "סיום סשן",
        pause: "השהיה",
